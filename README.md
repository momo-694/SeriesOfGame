...
This [Folder/Repo](https://github.com/momo-694/ApolProg) is created for educational purposes.

Any words used in every Folders/Files are not related to or meant to hurt anyone. As this Folder/Repo are __ONLY__ and __ONLY__ for educational purposes.

Please Understand, Thank you.

> [!IMPORTANT]
> Whatever you see/read here and marked as __hard__, worry not everything is not that __hard__ to understand. Just avoid getting overwhelmed.
